...
The released code expects a local `dataset/` directory. The dataset files are distributed as a separate archive and are **not versioned inside this Git repository**:
...
If you use this repository in your research, please cite the corresponding paper. Replace the placeholder below with the final bibliography metadata of your paper before public release:

```bibtex
@inproceedings{edgerefine,
